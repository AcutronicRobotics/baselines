...
def test(expert_path, traj_limitation, plot):
    dset = H_ros_Dset(expert_path, traj_limitation=traj_limitation)
    if plot:
        dset.plot()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--expert_path", type=str, default="/home/yue/experiments/expert_data/mara/expert_data_15_145_ws.npz")
